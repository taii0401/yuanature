...
<div class="row tm-mt-big">
    <div class="col-xl-12 col-lg-12 tm-md-12 tm-sm-12 tm-col">
        <div class="bg-white tm-block">
            ...
            <div class="table-responsive" style="display:{{ @$datas["assign_data"]["order_display"] }};">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 tm-btn-right">
                    <button type="button" class="btn btn-primary" onclick="changeForm('/orders/cart_cancel')">取消</button>
                    <button type="button" class="btn btn-danger" onclick="orderSubmit('add');">稍後付款</button>
                    <button type="button" class="btn btn-cart" onclick="orderSubmit('pay')">立即結帳</button>
                </div>
            </div>
        </div>
    </div>
